  ...
  return (
    <section className="hero-dark relative isolate overflow-hidden bg-background pt-28 pb-14 text-foreground md:pt-32 md:pb-16">
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        {/* Compact proof strip -- replaces a whole separate stats section */}
        <motion.div
          variants={fadeUp}
          custom={4}
          initial="hidden"
          animate="show"
          className="mx-auto mt-8 flex max-w-4xl flex-wrap items-center justify-center gap-x-10 gap-y-3 border-t border-border/70 pt-6"
        >
          {stats.map((s) => (
