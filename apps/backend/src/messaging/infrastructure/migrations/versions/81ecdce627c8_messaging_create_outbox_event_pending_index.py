"""messaging: create outbox_event pending-dispatch partial index

Revision ID: 81ecdce627c8
Revises: 98f4e9a7713f
...
revision: str = "81ecdce627c8"
down_revision: str | None = "98f4e9a7713f"
