...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Buy, rent, build, furnish and book — one AI-powered ecosystem for everything related to homes and buildings, worldwide." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "AI-powered global super app for buying, renting, building, furnishing and booking homes.",
        }),
      },
      {
        type: "application/ld+json",
