    ...
    <section id="about" className="relative isolate overflow-hidden py-20 md:py-28">
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid items-stretch gap-8 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] lg:gap-12">
          {/* Brand card */}
          <div className="relative overflow-hidden rounded-3xl border border-glass-border bg-gradient-to-br from-primary via-primary to-primary-glow p-8 shadow-elevated md:p-10">
            {/* decorative grid */}
            <div
              ...
              aria-hidden
            />
            <div className="pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full bg-primary-glow/40 blur-3xl" aria-hidden />
            <div className="pointer-events-none absolute -bottom-24 -left-24 h-72 w-72 rounded-full bg-accent/30 blur-3xl" aria-hidden />
            ...
            <div className="relative flex h-full flex-col">
              ...
              <div className="mt-8 overflow-hidden rounded-2xl border border-white/15 bg-white/[0.04] shadow-glow">
                <img
                  src="/uy-tamirlash-poster.jpg"
                  alt="Uy ta'mirlash — Active Home"
              ...
              <div className="mt-auto grid grid-cols-3 gap-3 pt-10">
                {[
                  ...
                  >
                    <div className="font-display text-2xl font-bold text-primary-foreground">{s.k}</div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-6 space-y-4 text-base leading-relaxed text-muted-foreground md:text-lg">
              <p>
                ...
                sotib olish va vositachilik xizmatlaridan tortib, ta'mirlash ishlari, usta xizmatlari
                hamda qurilish materiallari savdosigacha bo'lgan barcha yo'nalishlarni yagona tizimga
                birlashtiradi.
              </p>
              <p>
